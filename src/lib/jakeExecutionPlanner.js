...
export const SUGGESTED_ACTIONS = Object.freeze([
  ...
  'prepare_product_visual',
  'prepare_product_lock_flow',
...
const PLAN_TABLE = Object.freeze({
  ...
  product_visual: {
    planType: 'product_visual',
    steps: ['product-visual-brief', 'product-presenter', 'studio-workflow'],
    handoffTarget: 'studio',
    suggestedNextAction: 'prepare_product_visual',
    requiresConfirmation: true,
    seed: (userText, decision) => ({ builder: 'buildStudioPromptSeed', args: [decision.workflow || 'product-presenter', userText] }),
  },
  product_lock: {
    planType: 'product_lock_flow',
    steps: ['product-lock', 'exact-composite', 'seam-shadow-blend'],
    handoffTarget: 'studio',
    suggestedNextAction: 'prepare_product_lock_flow',
    requiresConfirmation: true,
    seed: (userText, decision) => ({ builder: 'buildStudioPromptSeed', args: [decision.workflow || 'product-lock', userText] }),
  },
  studio_prompt: {
    planType: 'studio_marketing_asset',

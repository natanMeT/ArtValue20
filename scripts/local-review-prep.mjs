...
export function computeGuardrails(files, statusPorcelain = '') {
  ...
  return {
    ...
    studioCreative: has(files, /(^|\/)src\/(pages\/ImageStudio\.jsx|components\/studio\/|lib\/(hostedImage|studioModes|presetAvailability|studioHandoff)\.js|data\/(studio|creativePresets|creativeWorkflows)\.js)/),
...
export function renderChecklist(g) {
  return [
    ...
    `- Studio (cloud creative) changed: ${yn(g.studioCreative)}`,

...
> | **Migration** | **NONE — no database object, no bucket, no policy, no API, no Edge, no package, no secret.** Migrations remain **16 applied of 16 tracked, NONE PENDING**; `ai-gateway` v36 ACTIVE / `verify_jwt=true`, untouched |
